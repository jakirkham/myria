...
@JsonSubTypes({
  ...
  @Type(name = "HyperCubeShuffleProducer", value = HyperShuffleProducerEncoding.class),
  @Type(name = "HyperCubeShuffleConsumer", value = HyperShuffleConsumerEncoding.class),
